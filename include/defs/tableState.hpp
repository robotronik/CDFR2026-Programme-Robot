...
class TableState
{
    public:
        ...
        inline bool remainingDropToStealExist(){for(size_t _ = 0; _ < DROPZONE_COUNT; _++ ){if(dropzone_states[_] == ((colorTeam == BLUE) ? DROPZONE_YELLOW : DROPZONE_BLUE)) return true;}; return false;}
